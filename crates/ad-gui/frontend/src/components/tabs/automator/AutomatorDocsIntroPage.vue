...
<template>
  <div>
    ...
    check the Automator How To Play entries for more details. Additionally there are two character limits to reduce
    lag, shown above the automator panels.
  </div>
</template>

<style scoped>
/* Vendored from the original AutomatorDocsIntroPage.vue scoped style. */
