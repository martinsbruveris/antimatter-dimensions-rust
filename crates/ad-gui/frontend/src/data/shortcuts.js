...
// easter-egg binds are never listed; both are omitted here too. The
// shortcuts themselves are not bound yet — this is the reference list the
// modal renders. Keep names/keys in sync with the original.
//
