// Automator docs data, vendored from
// ../antimatter-dimensions/src/core/secret-formula/reality/automator.js
// (the command man pages shown in the docs pane). `unlock` gates an entry on a
// snapshot flag: null = always shown, "blackHole" = BH1 unlocked, "enslaved" =
// celestial content (never at our frontier). The Currency List entry's
// celestial-gated lines (filter score / space theorems) are omitted — they
// are locked at our frontier.

export const AUTOMATOR_CATEGORY_NAMES = [
    "Time Studies",
    "Event Triggers",
    "Alter Settings",
    "Information",
...
export const AUTOMATOR_COMMAND_DOCS = [
    {
      id: 0,
      unlock: null,
