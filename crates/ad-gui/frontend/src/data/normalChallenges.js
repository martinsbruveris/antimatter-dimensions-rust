...
// `secret-formula/challenges/normal-challenges.js`, with formatInt(...)/formatX(...)
// inlined at their rendered values (e.g. C5's formatX(1.1245, 0, 3) = "×1.125").
...
export const NORMAL_CHALLENGES = [
  ...
  },
  {
    ...
    description: "The Tickspeed purchase multiplier starts at ×1.080 instead of ×1.125.",
